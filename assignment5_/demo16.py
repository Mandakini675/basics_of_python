"""--------------------
6. movie theatre calculates ticket prices based on age, show time, and day type.
...
show_time = input("show timing in morning ,evening:")
day = input("which day,weekend etc:")
if age<18:
